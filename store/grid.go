...
type GridConfigModel struct {
	...
	// Volatility profile thresholds (per-asset regime classification)
	NarrowBBWidth   float64 `json:"narrow_bb_width" gorm:"default:2.0"`
	StandardBBWidth float64 `json:"standard_bb_width" gorm:"default:3.0"`
	WideBBWidth     float64 `json:"wide_bb_width" gorm:"default:4.0"`
	NarrowATRPct    float64 `json:"narrow_atr_pct" gorm:"default:1.0"`
	StandardATRPct  float64 `json:"standard_atr_pct" gorm:"default:2.0"`
	WideATRPct      float64 `json:"wide_atr_pct" gorm:"default:3.0"`
	RangingBBWidth  float64 `json:"ranging_bb_width" gorm:"default:3.0"`
	TrendingBBWidth float64 `json:"trending_bb_width" gorm:"default:4.0"`
	RangingEMADist  float64 `json:"ranging_ema_dist" gorm:"default:1.0"`
	TrendingEMADist float64 `json:"trending_ema_dist" gorm:"default:2.0"`
	BreakoutPausePct float64 `json:"breakout_pause_pct" gorm:"default:2.0"`
}
