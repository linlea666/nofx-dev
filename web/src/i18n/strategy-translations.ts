...
export const gridConfig = {
  ...
  volatilityProfile: { zh: '波动率配置', en: 'Volatility Profile', es: 'Perfil de Volatilidad' },
  volatilityProfileDesc: { zh: '根据资产特性配置 regime 分类阈值，选择预设会自动填充', en: 'Configure regime classification thresholds per asset. Presets auto-fill on symbol change.', es: 'Configurar umbrales de régimen por activo' },
  presetLabel: { zh: '参数预设', en: 'Parameter Preset', es: 'Preajuste' },
  presetCrypto: { zh: '加密货币（默认）', en: 'Crypto (Default)', es: 'Cripto (Default)' },
  presetGold: { zh: '黄金 / 贵金属', en: 'Gold / Precious Metals', es: 'Oro / Metales' },
  presetCustom: { zh: '自定义', en: 'Custom', es: 'Personalizado' },
  narrowBBWidth: { zh: 'Narrow 布林带宽度上限 (%)', en: 'Narrow BB Width Limit (%)', es: 'Límite BB Narrow (%)' },
  standardBBWidth: { zh: 'Standard 布林带宽度上限 (%)', en: 'Standard BB Width Limit (%)', es: 'Límite BB Standard (%)' },
  wideBBWidth: { zh: 'Wide 布林带宽度上限 (%)', en: 'Wide BB Width Limit (%)', es: 'Límite BB Wide (%)' },
  narrowATRPct: { zh: 'Narrow ATR% 上限', en: 'Narrow ATR% Limit', es: 'Límite ATR% Narrow' },
  standardATRPct: { zh: 'Standard ATR% 上限', en: 'Standard ATR% Limit', es: 'Límite ATR% Standard' },
  wideATRPct: { zh: 'Wide ATR% 上限', en: 'Wide ATR% Limit', es: 'Límite ATR% Wide' },
  rangingBBWidth: { zh: 'AI震荡判定: 布林带宽度 (%)', en: 'AI Ranging: BB Width (%)', es: 'AI Rango: BB (%)' },
  trendingBBWidth: { zh: 'AI趋势判定: 布林带宽度 (%)', en: 'AI Trending: BB Width (%)', es: 'AI Tendencia: BB (%)' },
  rangingEMADist: { zh: 'AI震荡判定: EMA距离 (%)', en: 'AI Ranging: EMA Distance (%)', es: 'AI Rango: EMA (%)' },
  trendingEMADist: { zh: 'AI趋势判定: EMA距离 (%)', en: 'AI Trending: EMA Distance (%)', es: 'AI Tendencia: EMA (%)' },
  breakoutPausePct: { zh: '突破暂停阈值 (%)', en: 'Breakout Pause Threshold (%)', es: 'Umbral Pausa Ruptura (%)' },
  breakoutPausePctDesc: { zh: '价格突破网格范围的百分比，超过此值暂停网格', en: 'Grid pauses when price breaks range by this %', es: 'Pausa al romper rango' },
  symbolGroupCrypto: { zh: '加密货币', en: 'Crypto', es: 'Cripto' },
  symbolGroupHyperliquid: { zh: 'Hyperliquid 特色资产', en: 'Hyperliquid Special Assets', es: 'Activos Especiales HL' },
};
...
export const indicator = {
  ...
  macroData: { zh: '宏观指标', en: 'Macro Indicators', es: 'Indicadores Macro' },
