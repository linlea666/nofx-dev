...
export interface GridStrategyConfig {
  ...
  narrow_bb_width?: number;     // BB width upper limit for Narrow regime
  standard_bb_width?: number;   // BB width upper limit for Standard regime
  wide_bb_width?: number;       // BB width upper limit for Wide regime
  narrow_atr_pct?: number;      // ATR% upper limit for Narrow regime
  standard_atr_pct?: number;    // ATR% upper limit for Standard regime
  wide_atr_pct?: number;        // ATR% upper limit for Wide regime
  ranging_bb_width?: number;    // BB width indicating ranging market (for AI prompt)
  trending_bb_width?: number;   // BB width indicating trending market (for AI prompt)
  ranging_ema_dist?: number;    // EMA distance for ranging (for AI prompt)
  trending_ema_dist?: number;   // EMA distance for trending (for AI prompt)
  breakout_pause_pct?: number;  // % beyond boundary to pause grid
}
